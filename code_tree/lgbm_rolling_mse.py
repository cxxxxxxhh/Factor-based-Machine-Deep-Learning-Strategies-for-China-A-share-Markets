...
data_dir = "/home/cheam/IP_alpha/lgbm_rolling"
...
for i in range(len(year)-5): 
    ...
    if year[i][1] == 1:# 调参
        ...
        study_name="lgbm_" + train_start_date+'_' + test_start_date,
        direction=direction,
        load_if_exists=True,
        )
    ...
    model_name = data_dir + '/lgbm_' + train_start_date+'_'+test_start_date+ variable_part + '.json'
